// DeleteConfirmModal.jsx - Confirmation modal for deleting owner
import React, { useState } from 'react';
import { AlertTriangle, Trash2, X } from 'lucide-react';

const DeleteConfirmModal = ({ isOpen, onClose, owner, onConfirm }) => {
  ...
  const handleConfirm = async () => {
    try {
      setIsDeleting(true);
      setError('');
      await onConfirm(owner.userId || owner.id);
      onClose();
    } catch (err) {
      ...
      <div className="bg-white rounded-lg max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Delete Owner</h2>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">{owner.mobileNumber}</p>
              </div>
              {owner.email && (
                <div>
